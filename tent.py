    ...
    def forward(self, x):
        ...
        for _ in range(self.steps):
            if self.args.Add_TCA:
                embeddings, outputs = forward_and_adapt(x, self.model, self.optimizer, self.args, self.mixtta_layer_names)
            else:
                outputs = forward_and_adapt(x, self.model, self.optimizer, self.args, self.mixtta_layer_names)
...
def forward_and_adapt(x, model, optimizer, args, mixtta_layer_names):
